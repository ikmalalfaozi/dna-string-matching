...
const NoMatch = () => {
    ...
    useEffect(() => {
        dispatch(setSideBarValue({ value: [0, 0, 0, 0, 0, 0], showSidebar: false }));
    });
    return (
        <div class="flex w-full h-full justify-center items-center container mx-auto px-4 text-white">
            <section class="py-8 px-4 text-center">
                <div class="max-w-auto mx-auto">
                    <div class="md:max-w-lg mx-auto">
                        <svg class="fill-current" viewBox="0 0 445 202" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <p class="mt-6 uppercase text-sm lg:text-base">The page you are looking for might have been removed had its name changed or is temporarily unavailable.</p>
                    <button class="mt-6 bg-blue-700 hover:bg-blue-800 text-white font-light py-4 px-6 rounded-full inline-block uppercase shadow-md" onClick={() => navigate("/")}>
                        Back To Dashboard
                    </button>
                </div>
            </section>
